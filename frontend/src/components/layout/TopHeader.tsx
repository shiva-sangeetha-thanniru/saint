    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--line-soft)] bg-[rgba(243,247,251,0.82)] backdrop-blur-lg">
      <Container>
        <div className="flex h-16 items-center justify-between gap-3">
          <a href="#hero" className="inline-flex min-w-0 shrink-0 items-center gap-3" aria-label={`${APP_NAME} home`}>
            <span
              aria-hidden="true"
            ...
            <div className="min-w-0">
              <p className="font-display truncate text-sm font-semibold tracking-wide text-[var(--ink-900)] sm:text-base">{APP_NAME}</p>
